    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('enfermero', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='sitio.enfermeros')),
                ('sala', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='sitio.salas')),
            ],
        ),
        migrations.CreateModel(
            name='Llamados',
