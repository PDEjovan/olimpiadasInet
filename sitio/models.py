...
class Paciente(models.Model):
    ...
    alergia = models.CharField(max_length=255, blank=True, null=True, default='No')
    enfermedad_cronica = models.CharField(max_length=255, blank=True, null=True, default='No')
    tratamiento_medico = models.CharField(max_length=255, blank=True, null=True, default='No')
    enfermedades_o_cirugias = models.TextField(blank=True, null=True, default='No')
